...
class ThreeeDViewPage extends StatefulWidget {
  String hello;
  ThreeeDViewPage({super.key, required this.hello});

  @override
  State<ThreeeDViewPage> createState() => _ThreeeDViewPageState();
}
...
class _ThreeeDViewPageState extends State<ThreeeDViewPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Flutter3DViewer(
          ...
          src: 'assets/stadi2.glb', //3D model with different animations
